...
public sealed class BuildingEditor
{
    ...
    /// <summary>Building's own unique id (regenerated by FarmMapEditor.CloneEntityAt on
    /// paste/duplicate - every other clonable entity kind has no such uniqueness constraint).</summary>
