...
/// rewards (skill books, masteries). See PowerRowViewModel/PowersRoster for which kinds are
/// actually editable.</summary>
public sealed class PowersTabViewModel : ViewModelBase
{
    ...
    public void Bind(SaveGameEditor save)
    {
        ...
        foreach (var power in PowersRoster.All)
            Powers.Add(new PowerRowViewModel(power, save.Player));
    }
}
